...
var x=['./common/common/common.wxml','./pages/index/index.wxml','./pages/me/me.wxml','./pages/registLogin/registLogin.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
var bO=_n('view')
var oP=_mz(z,'image',['class',3,'src',1],[],e,s,gg)
_(bO,oP)
_(aL,bO)
}
else{aL.wxVkey=2
...
var b3=_n('navigator')
_rz(z,b3,'url',18,e,s,gg)
var o4=_mz(z,'image',['class',19,'src',1],[],e,s,gg)
_(b3,o4)
_(e2,b3)
_(eN,e2)
}
...
var h9=_mz(z,'image',['class',4,'src',1],[],e,s,gg)
_(c8,h9)
_(f7,c8)
var o0=_n('view')
...
_(cAB,oBB)
_(o0,cAB)
var lCB=_mz(z,'input',['class',9,'name',1,'placeholder',2,'placeholderClass',3,'type',4,'value',5],[],e,s,gg)
_(o0,lCB)
_(f7,o0)
...
_(tEB,eFB)
_(aDB,tEB)
var bGB=_mz(z,'input',['class',19,'name',1,'password',2,'placeholder',3,'placeholderClass',4,'type',5,'value',6],[],e,s,gg)
_(aDB,bGB)
_(f7,aDB)
var oHB=_mz(z,'button',['formType',26,'style',1,'type',2],[],e,s,gg)
...
var tSB=_mz(z,'image',['bindtap',39,'class',1,'data-event-opts',2,'data-logintype',3,'src',4],[],e,s,gg)
_(aRB,tSB)
var eTB=_mz(z,'image',['bindtap',44,'class',1,'data-event-opts',2,'data-logintype',3,'src',4,'style',5],[],e,s,gg)
_(aRB,eTB)
var bUB=_mz(z,'image',['bindtap',50,'class',1,'data-event-opts',2,'data-logintype',3,'src',4,'style',5],[],e,s,gg)
_(aRB,bUB)
_(oJB,aRB)
_(o6,oJB)
_(r,o6)
...
__wxAppCode__['common/common/common.wxss']=undefined;    
__wxAppCode__['common/common/common.wxml']=$gwx('./common/common/common.wxml');
